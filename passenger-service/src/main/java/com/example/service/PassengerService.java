...
public class PassengerService {
	...
	public ResponseEntity<PassengerDetailsResponse> getPassengerDetailsService(@PathVariable int id)
		...
		PassengerDetailsResponse passengerDetails = PassengerDetailsResponse.builder().email(passenger.getEmail())
				.phoneNum(passenger.getPhoneNumber()).name(passenger.getName()).build();
